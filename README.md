...
EMU-Script is a text-based, electronic music composition software for MacOS and iPadOS. 
...
- An overview video is available on [youtube](https://www.youtube.com/@EMU-Script) (version 1.0)
...
- Vertical scrolling.
- Mute buttons that can be used during playback.
- Dark mode support.
